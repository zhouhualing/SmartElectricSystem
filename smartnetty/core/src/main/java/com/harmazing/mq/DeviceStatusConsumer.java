...
import com.harmazing.cache.DeviceStatusThreadCache;
...
public class DeviceStatusConsumer implements MessageListener {
	...
	public DeviceStatusConsumer(String dest){
		i++;		
		try {
	...
	public void onMessage(Message message) {
		try{
	    	 ...
	    	 DeviceStatusThread t=(DeviceStatusThread) DeviceStatusThreadCache.get(area);
    		 if(t==null){	
    			 t=new DeviceStatusThread(area);
    			 DeviceStatusThreadCache.put(area, t);
    			 t.start();    			 
    		 }
    		 t.addDevice(device);
		}catch(Exception e){
