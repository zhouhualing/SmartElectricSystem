...
$(function(){
	...
	if(task == 1){
		...
		getCurrenUserInfo(function(data){
			...
			$("#reportInfoQuery").attr("queryId","allReceivedocShowQuery");
		...
		getCurrenUserInfo(function(data){
			$("#createUserCode").val(data.userCode);
			$("#reportInfoQuery").attr("queryId","allReceivedocShowspzQuery");
		...
		getCurrenUserInfo(function(data){
			$("#createUserCode").val(data.userCode);
			$("#reportInfoQuery").attr("queryId","allReceivedocShowyffQuery");
		...
		getCurrenUserInfo(function(data){
			$("#createUserCode").val(data.userCode);
			$("#reportInfoQuery").attr("queryId","allReceivedocShowybjQuery");
