...
$(function(){
	...
	if(task == 1){
		...
		getCurrenUserInfo(function(data){
			...
			$("#localUserCode").after('<input type="hidden" value="0001" name="reportType"  id="reportType" />');
			$("#reportInfoQuery").attr("queryId","partakesFWQuery");
		...
		getCurrenUserInfo(function(data){
			$("#localUserCode").val(data.userCode);
			$("#localUserCode").after('<input type="hidden" value="0005" name="reportType"  id="reportType" />');
			$("#reportInfoQuery").attr("queryId","partakesFWQuery");
