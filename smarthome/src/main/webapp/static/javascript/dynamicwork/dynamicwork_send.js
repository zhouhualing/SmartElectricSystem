...
function sendDynaWork(){
	doJsonRequest("/noticenter/addLeadersTodo",{id:$("#id").val(),title:$("#title").val()},function(data){
		window.location.href="../tododocs/docs_down.html?fromPage=0002&flag=7&btnSource=app&mark=006";
	});
	/*var obj = {
		    title:'选择发送领导',
		    height:"350px",
		    width:"650px",
		    url:'send_role_list.html',
		    myCallBack:"doSendDynaWork"
		};
		new jqueryDialog(obj);*/
}

/*function doSendDynaWork(data){
	var roleCodes = "";
	...
	doJsonRequest("/noticenter/addTodo",{roleCodes:roleCodes,id:$("#id").val(),title:$("#title").val()},function(data){
		window.location.href="../tododocs/docs_down.html?fromPage=0002&flag=7&btnSource=app&mark=006";
	});
}*/
