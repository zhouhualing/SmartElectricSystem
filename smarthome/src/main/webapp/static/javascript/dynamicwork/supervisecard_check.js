...
$("#id").val(id);
$("#businessKey").val(id);
var mark = getURLParam("mark"); //当前收文id
var superType = getURLParam("superType");
if(superType == '0001'){
	$("#businessType").val("superviseSZ");
}else if(superType == '0002'){
	$("#businessType").val("superviseFSZ");
}
...
$(function(){
	...
	if(id != null) {
		var dto = {id:id}
		var url = "/super/getSuperVise";
		if(mark=='b'){
			url = "/super/getBranchSuper";
		}
