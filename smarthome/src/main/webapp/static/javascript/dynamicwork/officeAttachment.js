...
'   <tr class="template-upload">'+
		...
		'        <a style="color:#428bca" href="javascript:void(0);" theUrl= "{%=file.pdfUrl%}" onclick="openAttachments(&quot;{%=file.url%}&quot;,&quot;{%=file.type%}&quot;,this)" title="{%=file.name%}">{%=file.name%}</a>'+
		'   </p>'+
		'   {% if (file.error) { %}'+
		...
		'   <a href = "{%=file.url%}"><button type="button" onclick ="window.location.href=\'{%=file.url%}\'" class="btn_select" >下载</button></a>'+
