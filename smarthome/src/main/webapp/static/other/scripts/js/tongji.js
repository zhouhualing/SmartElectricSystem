...
{
	var unit_id     = "1870888";
	var client_ip   = "220.181.78.164";
	var server_time = "1379915881";
	var verify_code = "7fdbc45d";
	var type        = "0";
	var dest_path   = "../scripts/js//tongji.js"+unit_id; 
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1870888/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
